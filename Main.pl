...
diagnose(PatientName) :-
    ...
    write_ln("Medical Diagnostic System: Developed by Felix Koki Daudi."),
    write_ln("School of Computing and Information Technology, Jomo Kenyatta University of Agriculture and Technology.\n"),
